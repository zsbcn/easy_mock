...
后端: python 3.13, fastapi 0.121.2, sqlmodel 0.0.27, uvicorn 0.38.0, itsdangerous 2.1.2, pyyaml 6.0.3, loguru 0.7.3
...
2. 切到src目录下, 命令行输入`uv run uvicorn main:app`即可启动服务
如图所示即后端项目启动成功
